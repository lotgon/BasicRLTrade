...
easyEnvData_FileName    <- file.path(OutputFolder, "easyEnvData.csv")
easyAgentData_FileName  <- file.path(OutputFolder, "easyAgentData.csv")
...
easyquotes <- quotes[smallIndex,]
easyAgentData <- BuildAgentData(easyquotes, Window_size, RawCenters_FileName, easyAgentData_FileName )

fwrite(easyquotes, easyEnvData_FileName)

ggplot(easyquotes[1:(24*Window_size), .(i = .I, close.bid)], aes(x=i, y=close.bid)) + geom_point()
```
